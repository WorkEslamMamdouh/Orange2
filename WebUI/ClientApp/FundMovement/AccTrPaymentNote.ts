...
namespace AccTrPaymentNote {
    ...
    var G_Currency_: G_Currency = new G_Currency();
    ...
    var SysSession: SystemSession = GetSystemSession(Modules.AccTrPaymentNote);
   ...
   // var btnPrint: HTMLButtonElement;
    ...
    function btnBenCust_onclick() {
        ...
        sys.FindKey(Modules.AccTrPaymentNote, "btnCustSrch", "CompCode= " + compcode + "" + cond, () => {
    ...
    function btnBenBox_onclick() {
        ...
        sys.FindKey(Modules.AccTrPaymentNote, "btnBoxSearch", "CompCode= " + compcode + " and IsActive = 1", () => {
            var id = SearchGrid.SearchDataGrid.SelectedKey;
