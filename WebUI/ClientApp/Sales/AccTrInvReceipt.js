...
var AccTrInvReceipt;
(function (AccTrInvReceipt) {
    //system varables
    var invoiceID;
    var SysSession = GetSystemSession(Modules.AccTrInvReceipt);
    var compcode;
    ...
    var ItemDetailsStoreInfo = new Array();
    var ItemDetails = new Array();
    var AD_VatTypeDetails = new A_D_VAT_TYPE();
    //StoreDetails = result.Response as G_STORE;
    var StoreDetails = new G_STORE(); //
    //Models
    var SlsInvoiceListModel = new Array();
    ...
    var lblInvoiceDate;
    var lblInvoiceCustomer;
    var lblInvoiceSalesman;
    var lblInvoiceCustomerMobile;
    var lblInvoiceStore;
    //flags
    var NetTot = 0;
    var CommisionTot = 0;
    ...
    AccTrInvReceipt.InitalizeComponent = InitalizeComponent;
    ...
    function InitalizeControls() {
        ...
        txtNetInv = document.getElementById("txtNetInv");
        txtCommisionInv = document.getElementById("txtCommisionInv");
        txtPaidAmountInv = document.getElementById("txtPaidAmountInv");
        txtCashInv = document.getElementById("txtCashInv");
        txtCardInv = document.getElementById("txtCardInv");
        //buttons
        ...
        lblInvoiceDate = document.getElementById("lblInvoiceDate");
        lblInvoiceCustomer = document.getElementById("lblInvoiceCustomer");
        lblInvoiceSalesman = document.getElementById("lblInvoiceSalesman");
        lblInvoiceCustomerMobile = document.getElementById("lblInvoiceCustomerMobile");
        lblInvoiceStore = document.getElementById("lblInvoiceStore");
        ...
        Grid.Columns = [
            ...
            },
            {
                ...
                itemTemplate: function (s, item) {
                    var txt = CreateElement("number", "form-control disabled", " ", " ", "", " ");
                    txt.id = "txtcash";
    ...
    function btnExecute_onclick() {
        ...
        for (var i = 0; i < FilteredModel.length; i++) {
            var cash = FilteredModel[i].CashAmount;
            var card = FilteredModel[i].CardAmount;
        ...
        if (ValidDataFlag == 1) {
            ...
            UpdatedModel = UpdatedModel.filter(function (s) { return s.CardAmount != 0 || s.CashAmount != 0; });
    ...
    function GetAllIItem() {
        ...
        Ajax.Callsync({
            ...
            success: function (d) {
                var result = d;
                if (result.IsSuccess) {
                    ItemDetailsStoreInfo = result.Response;
                }
            }
        });
    }
    function FillddlItem(ItemFamilyID, StoreId) {
        ItemDetails = ItemDetailsStoreInfo.filter(function (x) { return x.ItemFamilyID == ItemFamilyID && x.StoreId == StoreId; });
    }
    ...
    function cashOrCredit_onchange() {
        var cash = Number(txtCashInv.value);
        var card = Number(txtCardInv.value);
        var Remain = Number(txtPaidAmountInv.value);
        if (Remain != (card + cash)) {
...
//# sourceMappingURL=AccTrInvReceipt.js.map