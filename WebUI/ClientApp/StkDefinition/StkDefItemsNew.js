...
(function (StkDefItemsNew) {
    ...
    var SysSession = GetSystemSession(Modules.StkDefItemsNew);
    ...
    function InitalizeControls() {
        ...
        ID_Print = document.getElementById("ID_Print");
            ...
            success: function (d) {
                ...
                if (result.IsSuccess) {
                    ...
                    for (var i = 0; i < Details.length; i++) {
                        var Type = Display_Type.filter(function (x) { return x.CatID == Details[i].CatID; });
    ...
    function BindGetOperationItemsGridData(ItemID) {
        Ajax.Callsync({
            type: "Get",
