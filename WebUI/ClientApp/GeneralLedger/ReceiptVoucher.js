...
(function (ReceiptVoucher) {
    ...
    var SysSession = GetSystemSession(Modules.ReceiptVoucher);
    var compcode;
    var VoucherCCType = 0;
    ...
    ReceiptVoucher.InitalizeComponent = InitalizeComponent;
    //------------------------------------------------------ Main Region -----------------------------------
    ...
    function BuildControls(cnt) {
        ...
        $('#btnSearchAcc' + cnt).click(function (e) {
            var sys = new SystemTools();
            if (VoucherCCDtType == 1) {
                sys.FindKey(Modules.ReceiptVoucher, "btnAccountSearch", "COMP_CODE=" + compcode + "and ACC_ACTIVE = 1 and DETAIL =1 and CCDT_TYPE IS NOT NULL and  CCDT_TYPE != ''", function () {
                    var id = SearchGrid.SearchDataGrid.SelectedKey;
                ...
                sys.FindKey(Modules.ReceiptVoucher, "btnAccountSearch", "COMP_CODE=" + compcode + "and ACC_ACTIVE = 1 and DETAIL =1 ", function () {
                    var id = SearchGrid.SearchDataGrid.SelectedKey;
                    $('#txtAccNumber' + cnt).val(id);
                    if (GetAccByCode(id)) {
                        $('#txtAccName' + cnt).val((lang == "ar" ? AccountDetails.ACC_DESCA : AccountDetails.ACC_DESCL));
...
//# sourceMappingURL=ReceiptVoucher.js.map